...
public class Main {
	...
	public static void main(String[] args) {
		...
		ArrayList<Pessoa> pessoas = new ArrayList<Pessoa>();
			...
			estudante01.addCursoNota("Português", 10);
			
			Estudante estudante02 = new Estudante("Rodrigo", "Recife - PE");
			estudante02.addCursoNota("Matemática", 10);
			estudante02.addCursoNota("Português", 9);
		
			
			Estudante estudante03 = new Estudante("Francisco", "Jaboatão - PE");
			estudante03.addCursoNota("Matemática", 8);
			estudante03.addCursoNota("Português", 9);
			pessoas.add(estudante01);
			pessoas.add(estudante02);
			pessoas.add(estudante03);

			Professor  professor01 = new Professor("Júlio Cesar", "Recife-PE");
			professor01.addCurso("matematica");
			
			
			Professor professor02 = new Professor("Maria", "Olinda-PE");
			professor02.addCurso("Português");
